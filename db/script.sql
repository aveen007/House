...
COPY public.patients (patient_id, first_name, last_name, date_of_birth, gender, insurance_company_id, age) FROM stdin;
\.
...
SELECT pg_catalog.setval('public.patient_insurance_id_seq', 1, false);
